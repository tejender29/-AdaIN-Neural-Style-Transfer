...
def parse_arguments():
    ...
    parser.add_argument(
        '--content_dir',
        type=str,
        default='/Users/tejendersingh/Desktop/NST_CODE/content_data',
    ...
    parser.add_argument(
        '--style_dir',
        type=str,
        default='/Users/tejendersingh/Desktop/NST_CODE/style_data',
    ...
    parser.add_argument(
        '--vgg',
        type=str,
        default='/Users/tejendersingh/Desktop/NST_CODE/vgg_normalised.pth',
